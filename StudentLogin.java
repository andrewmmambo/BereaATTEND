...
public class StudentLogin extends JFrame {
	...
	public StudentLogin() {
		...
		JLabel lblFacultyLoginForm = new JLabel("Student Login Form");
		lblFacultyLoginForm.setForeground(Color.GRAY);
		lblFacultyLoginForm.setFont(new Font("Tahoma", Font.PLAIN, 18));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(124)
							.addComponent(lblFacultyLoginForm))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(19)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
